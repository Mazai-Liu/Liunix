...
static u16 erase = 0x0720;  // 07是样式  20是空格
...
static void set_cursor() {
    ...
    outw(CRT_DATA_REG, ((pos - MEM_BASE) >> 1) & 0xff);
}
...
static void set_screen() {
    ...
    outb(CRT_ADDR_REG, CRT_START_ADDR_L);
    outw(CRT_DATA_REG, ((screen - MEM_BASE) >> 1) & 0xff);
}
